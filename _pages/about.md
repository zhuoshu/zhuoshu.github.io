...
✨ I am currently seeking opportunities in deep learning, machine learning, and foundation model (LLM) research or applications.
📬 *If you are interested in related research, would like to discuss potential collaboration, or know of relevant opportunities, feel free to contact me!*

--- 
Hi！我是郑启，同济大学博士研究生，预计于2026年8月毕业。我的研究聚焦于**高效、可扩展且具备持续适应能力的时空预测方法**，研究对象是**时序与图结构数据**，主要面向交通、气象、能源等传感网络中的复杂动态建模问题。我的核心关注点是，如何在保证预测性能的同时提升模型的计算效率，并使模型能够适应时间与空间结构的动态演化。
